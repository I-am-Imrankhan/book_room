...
class BookingService {
  ...
  Future<List<TimeSlot>> getAvailableTimeSlots(String roomId, DateTime date) async {
  ...
  Future<void> createBooking(Booking booking) async {
    ...
    final availableSlots = await getAvailableTimeSlots(booking.roomId, booking.date);
    final isSlotAvailable = availableSlots
        .where((slot) => slot.hour >= booking.startHour && 
